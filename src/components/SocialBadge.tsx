...
const styles: Record<keyof SocialLinks, { label: string; className: string; icon: ReactNode }> = {
  reddit: {
    label: 'Reddit',
    className: 'bg-orange-100 text-orange-800 border-orange-200 dark:bg-orange-500/20 dark:text-orange-100 dark:border-orange-400/60',
    icon: (
  ...
  twitter: {
    label: 'Twitter',
    className: 'bg-sky-100 text-sky-800 border-sky-200 dark:bg-sky-500/20 dark:text-sky-100 dark:border-sky-400/60',
    icon: (
      <svg className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor" aria-hidden>
  ...
  linkedin: {
    label: 'LinkedIn',
    className: 'bg-blue-100 text-blue-800 border-blue-200 dark:bg-blue-500/20 dark:text-blue-100 dark:border-blue-400/60',
    icon: (
      <svg className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor" aria-hidden>
        <path
          fillRule="evenodd"
  ...
  patreon: {
    label: 'Patreon',
    className: 'bg-rose-100 text-rose-800 border-rose-200 dark:bg-rose-500/20 dark:text-rose-100 dark:border-rose-400/60',
    icon: (
