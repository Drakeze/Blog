    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-4 py-20 md:px-6">
        <div className="mb-10 text-center">
          <h1 className="mb-4 text-4xl font-semibold tracking-tight text-secondary md:text-6xl">Stay in the loop</h1>
          <p className="text-lg text-muted-foreground text-balance md:text-xl">
            Get new posts delivered to your inbox. No account needed — just your email.
          </p>
        </div>
