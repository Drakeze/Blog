...
const SOCIAL_LINKS = [
  { href: "https://x.com/SorenIdeas", label: "Twitter / X", icon: <XIcon /> },
  { href: "https://github.com/Drakeze", label: "GitHub", icon: <GitHubIcon /> },
  { href: "https://www.linkedin.com/in/anthonyshead/", label: "LinkedIn", icon: <LinkedInIcon /> },
  { href: "https://www.reddit.com/user/Putrid-Economy1639/", label: "Reddit", icon: <RedditIcon /> },
]
