export const SOCIAL_PROFILES = {
  linkedin:
    ...
    "https://www.linkedin.com/in/anthonyshead/",
  reddit:
    process.env.NEXT_PUBLIC_REDDIT_PROFILE ??
    "https://www.reddit.com/user/Putrid-Economy1639/",
  twitter:
    process.env.NEXT_PUBLIC_TWITTER_PROFILE ??
    "https://x.com/SorenIdeas",
} as const;
